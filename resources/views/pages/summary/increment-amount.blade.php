...
<div id="increment" class="vh-100 overflow-y-auto overflow-x-hidden secondary-default-bg">
                ...
                <div class="container">
                    <div class="row justify-content-center align-items-center">
                        ...
                        <div class="col-md-6 d-flex justify-content-start">
                            <div class="col-xxl-7">
                                <h2 class="display-5 fw-bold text-start lh-base">I am expecting my income to increase by</h2>
                ...
                <div class="container">
                    <div class="row position-relative">
                        <div class="col-md-6 text-center position-absolute justify-content-center align-items-center d-flex" style="bottom: -150px">
                            <img src="{{ asset('images/summary/vector.png') }}" width="auto" height="500px" alt="Increment">
                        </div>
                    </div>
                </div>
                    ...
                    <div class="container-fluid">
                        <div class="row">
                            <div class="col-12 d-flex gap-2 d-md-block text-end px-4">
                                <a href="{{route('pages.summary.expected-income')}}" class="btn btn-secondary flex-fill me-md-2 text-uppercase">Back</a>
