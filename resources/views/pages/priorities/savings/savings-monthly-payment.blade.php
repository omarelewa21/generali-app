...
@php
    ...
    $savingsMonthlyPayment = isset($arrayData['savingsMonthlyPayment']) ? $arrayData['savingsMonthlyPayment'] : '';
    $totalSavingsNeeded = isset($arrayData['totalSavingsNeeded']) ? $arrayData['totalSavingsNeeded'] : '';
    $savingsFundPercentage = isset($arrayData['savingsFundPercentage']) ? $arrayData['savingsFundPercentage'] : 0;
@endphp
