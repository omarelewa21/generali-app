                ...
                <div class="wrapper-needs-grey main-default-bg">
                    ...
                    <section class="content-needs">
                        <div class="col-12 d-flex justify-content-center align-items-center position-relative">
                            <img src="{{ asset('images/needs/savings/home/avatar.png') }}" height="100%" width="auto" class="position-absolute" style="bottom:-50px" alt="Savings Home">
                        </div>
                    </section>
                            ...
                            <div class="container-fluid">
                                <div class="row">
                                    <div class="col-12 d-flex gap-2 d-md-block text-end px-4">
                                        @php
                                            if ($educationPriority === 'true' || $educationPriority === true) {
