                    ...
                    <section class="content-needs">
                        <div class="col-12 justify-content-center align-items-center position-relative d-xl-flex d-none">
                            @if(isset($gender) || isset($skintone))
                                <div id="lottie-animation" class="position-absolute needs_avatar" style="bottom:-55px;"></div>
                            @else
                                <img src="{{ asset('images/needs/savings/home/avatar.png') }}" height="90%" width="auto" class="position-absolute" style="bottom:-55px" alt="Savings Home">
                            @endif
                        </div>
                    </section>
