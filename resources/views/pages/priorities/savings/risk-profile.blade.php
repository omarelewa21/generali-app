                        ...
                        <div class="row h-100">
                            ...
                            <div class="col-xl-4 col-lg-6 col-md-6 py-5 order-md-2 order-1 order-sm-1">
                                ...
                                <div class="col-12 mb-3 z-1">
                                    <button class="risk-btn f-family @if($savingsRiskProfile === 'High Risk') default @endif" id="high-risk" data-avatar="High Risk" data-required="{{old('savingsRiskProfileInput') === 'High Risk' ? 'selected' : ''}}">High Risk</button>
                                </div>
                                ...
                                <div class="col-12 mb-3 z-1">
                                    <button class="risk-btn f-family @if($savingsRiskProfile === 'Medium Risk') default @endif" id="medium-risk" data-avatar="Medium Risk" data-required="{{old('savingsRiskProfileInput') === 'Medium Risk' ? 'selected' : ''}}">Medium Risk</button>
                                </div>
                                ...
                                <div class="col-12 mb-3 z-1">
                                    <button class="risk-btn f-family @if($savingsRiskProfile === 'Low Risk') default @endif" id="low-risk" data-avatar="Low Risk" data-required="{{old('savingsRiskProfileInput') === 'Low Risk' ? 'selected' : ''}}">Low Risk</button>
                                </div>
