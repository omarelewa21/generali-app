                    ...
                    <div class="col-12 col-md-6 col-lg-6 col-xxl-7 col-xl-7 wrapper-avatar-default bg-white order-md-1 order-sm-2 order-2">
                        ...
                        <section class="content-avatar-default">
                            <div class="col-12 text-center position-relative">
                                ...
                                <!-- <p class="f-40 f-family fw-bold lh-normal m-0">I Plan to have a saving goal of<br>
                                    <span class="text-primary fw-bold border-bottom border-dark border-3">RM<input type="text" name="savings_goals_amount" class="form-control f-40 f-family fw-bold position-relative border-0 d-inline-block w-50 text-primary @error('savings_goals_amount') is-invalid @enderror" id="savings_goals_amount" value="{{ $goalsAmount !== null ? number_format(floatval($goalsAmount)) : $goalsAmount }}" required></span>
                                </p> -->
                                <div id="sortable-main" class="position-relative pt-3">
                                    ...
                                    <div id="sortable" class="position-absolute pt-3">
                                        <div class="svg-container first d-flex justify-content-center align-items-center position-relative @if(isset($savingsGoals) && isset($savingsGoals[0])) item-dropped @endif" data-svg-class="first">
                                            <div class="svg-button px-0 d-flex justify-content-center align-items-center">
                                                ...
                                                @else
                                                    <div class="dropped position-absolute d-flex justify-content-center align-items-center" data-identifier="{{$savingsGoals[0]}}">
                                                        <div class='sortable-container'>
                                                            <img class="inner-dropped" src="{{ asset('images/needs/savings/goals/goal-' . $savingsGoals[0] . '-icon.png') }}" style="width: 100px;">
                                                            <button class="remove-button" data-identifier="{{$savingsGoals[0]}}"><img class="close" src="/images/top-priorities/close.png" width="100%"></button>
                                                        </div>
                                                    </div>
                                                @endif
                                        ...
                                        <div class="svg-container second d-flex justify-content-center align-items-center position-relative @if(isset($savingsGoals) && isset($savingsGoals[1])) item-dropped @endif" data-svg-class="second">
                                            <div class="svg-button px-0 d-flex justify-content-center align-items-center">
                                                @if(!isset($savingsGoals) || !isset($savingsGoals[1]))
                                                    <div class="dropped position-absolute d-flex justify-content-center align-items-center"></div>
                                                @else
                                                    <div class="dropped position-absolute d-flex justify-content-center align-items-center" data-identifier="{{$savingsGoals[1]}}">
                                                        <div class='sortable-container'>
                                                            <img class="inner-dropped" src="{{ asset('images/top-priorities/' . $savingsGoals[1] . '-icon.png') }}" style="width: 100px;">
                                                            <button class="remove-button" data-identifier="{{$savingsGoals[1]}}"><img class="close" src="/images/top-priorities/close.png" width="100%"></button>
                                                        </div>
                                                    </div>
                                                @endif
                                        ...
                                        <div class="svg-container third d-flex justify-content-center align-items-center position-relative @if(isset($savingsGoals) && isset($savingsGoals[2])) item-dropped @endif" data-svg-class="third">
                                            <div class="svg-button px-0 d-flex justify-content-center align-items-center">
                                                @if(!isset($savingsGoals) || !isset($savingsGoals[2]))
                                                    <div class="dropped position-absolute d-flex justify-content-center align-items-center"></div>
                                                @else
                                                    <div class="dropped position-absolute d-flex justify-content-center align-items-center" data-identifier="{{$savingsGoals[2]}}">
                                                        <div class='sortable-container'>
                                                            <img class="inner-dropped" src="{{ asset('images/top-priorities/' . $savingsGoals[2] . '-icon.png') }}" style="width: 100px;">
                                                            <button class="remove-button" data-identifier="{{$savingsGoals[2]}}"><img class="close" src="/images/top-priorities/close.png" width="100%"></button>
                                                        </div>
                                                    </div>
                                                @endif
                                        ...
                                        <div class="svg-container fourth d-flex justify-content-center align-items-center position-relative @if(isset($savingsGoals) && isset($savingsGoals[3])) item-dropped @endif" data-svg-class="fourth">
                                            <div class="svg-button px-0 d-flex justify-content-center align-items-center">
                                                @if(!isset($savingsGoals) || !isset($savingsGoals[3]))
                                                    <div class="dropped position-absolute d-flex justify-content-center align-items-center"></div>
                                                @else
                                                    <div class="dropped position-absolute d-flex justify-content-center align-items-center" data-identifier="{{$savingsGoals[3]}}">
                                                        <div class='sortable-container'>
                                                            <img class="inner-dropped" src="{{ asset('images/top-priorities/' . $savingsGoals[3] . '-icon.png') }}" style="width: 100px;">
                                                            <button class="remove-button" data-identifier="{{$savingsGoals[3]}}"><img class="close" src="/images/top-priorities/close.png" width="100%"></button>
                                                        </div>
                                                    </div>
                                                @endif
                                ...
                                <div class="col-12 position-absolute" style="top: 50%; height:350px;">
