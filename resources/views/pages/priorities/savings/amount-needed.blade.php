                    ...
                    <div class="container">
                        <div class="row justify-content-center">
                            <div class="col-md-4 bg-primary calculation-progress-bar-wrapper">
                                ...
                                <h1 id="TotalSavingsFund" class="text-center display-3 text-uppercase text-white">RM{{ 
                                ...
                                <p class="text-white display-6 lh-base text-center">Total Savings Needed</p>
                            </div>
                        </div>
                    </div>
                </section>
                    ...
                    <div class="container h-100">
                        <div class="row h-100">
                            <div class="col-md-6 h-100 order-md-1 order-sm-2 order-2 d-flex justify-content-center align-items-end tertiary-mobile-bg">
                                <img src="{{ asset('images/needs/savings/monthly-payment/avatar.png') }}" width="auto" height="100%" alt="Increment">
                            </div>
