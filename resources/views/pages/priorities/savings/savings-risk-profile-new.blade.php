...
<div id="savings-risk-profile"  class="vh-100 scroll-content">
        ...
        <div class="row h-100">
            <div class="col-12">
                <div class="row h-100 bg-needs-desktop bg-half wrapper-needs-supporting-default">
                    ...
                    <form novalidate action="{{route('validate.savings.risk.profile')}}" method="POST" class="m-0 content-supporting-default">
                        @csrf
                                ...
                                <div class="row h-100" id="needs-content">
                                    <div class="col-12 col-xl-6 d-flex align-items-end justify-content-center z-1 mh-100 second-order">
                                        ...
                                        <div class="col-12 position-absolute bottom-0 show-mobile">
                                            <div class="row">
                                                <div class="needs-stand-bg bg-btn_bar {{ $errors->has('savingsPotentialReturnInput') ? 'error-padding' : '' }}"></div>
                                            </div>
                                        </div>
                                    </div>
