                    ...
                    <section class="overflow-auto overflow-hidden row content-block">
                        ...
                        <div class="col-11 m-auto selection-content-coverage h-100 coverage_slick z-1">
                            <div class="slick-slide h-100 mh-100 d-flex justify-content-center align-items-center">
                                <button class="border-0 bg-transparent choice h-100 slick-padding mt-auto button-needs justify-content-center align-items-center @if($savingsSelectedAvatar === $selfData['first_name'].' '.$selfData['last_name']) default @endif" id="{{ $selfData['first_name'] }} {{ $selfData['last_name'] }}" data-avatar="{{ $selfData['first_name'] }} {{ $selfData['last_name'] }}" data-required="">
