...
<div id="savings-risk-profile" class="vh-100 bg-master-mob">
    <div class="container-fluid">
        <div class="row">
            <div class="col-12 vh-100 wrapper-needs-coverage-default bg-education-gap">
                ...
                <form novalidate action="{{route('validate.savings.risk.profile')}}" method="POST" class="content-needs-default m-0">
                    @csrf
                    <section class="overflow-auto overflow-hidden row content-block">
                        ...
                        <div class="col-12 risk-selection">
                            <div class="row d-flex justify-content-center align-items-center text-center">
                                <div class="col-md-2 col-4 d-flex justify-content-center align-items-center px-1">
                                    <button class="border-0 w-100 risk-btn f-family @if($savingsRiskProfile === 'high-risk') default @endif" id="high-risk" data-avatar="high-risk" data-required="">High Risk</button>
                                </div>
                                <div class="col-md-2 col-4 d-flex justify-content-center align-items-center px-1">
                                    <button class="border-0 w-100 risk-btn f-family @if($savingsRiskProfile === 'medium-risk') default @endif" id="medium-risk" data-avatar="medium-risk" data-required="">Medium Risk</button>
                                </div>
                                <div class="col-md-2 col-4 d-flex justify-content-center align-items-center px-1">
                                    <button class="border-0 w-100 risk-btn f-family @if($savingsRiskProfile === 'low-risk') default @endif" id="low-risk" data-avatar="low-risk" data-required="">Low Risk</button>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-12">
                            <div class="row">
                                <div class="position-absolute bg-btn_bar bottom-0 needs-stand-bg {{ $errors->has('savingsRiskProfileInput') ? 'error-padding' : '' }}"></div>
                            </div>
                        </div>
                    </section>
                    @if ($errors->has('savingsRiskProfileInput'))
                        <section class="row warning z-1">
                            <div class="col-12 alert alert-danger d-flex justify-content-center align-items-center py-2 m-0 rounded-0" role="alert">
                                ...
                                <div class="text">{{ $errors->first('savingsRiskProfileInput') }}</div>
                            </div>
                        </section>
                    @endif
                        ...
                        <div class="container-fluid">
                            <div class="row">
                                <div class="col-12 d-flex gap-2 d-md-block text-end px-4">
                                    <input type="hidden" name="savingsRiskProfileInput" id="savingsRiskProfileInput" value="{{$savingsRiskProfile}}">
