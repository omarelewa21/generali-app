        ...
        <div class="row vh-100 scroll-content">
            <div class="col-12">
                <div class="row h-100 wrapper-needs-full-master-default bg-needs-master-full">
                    ...
                    <form novalidate action="{{route('validate.goal.duration')}}" method="POST" class="m-0 content-full-master-default @if ($errors->has('savings_goal_duration')) pb-7 @endif">
                        @csrf
                                ...
                                <div class="container-fluid">
                                    <div class="row">
                                        <div class="col-12 d-flex gap-2 d-md-block text-end px-4">
                                            <a href="{{route('savings.monthly.payment')}}" class="btn btn-secondary flex-fill me-md-2 text-uppercase">Back</a>
