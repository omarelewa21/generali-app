...
<div id="debt-coverage" class="vh-100">
    <div class="container-fluid">
        <div class="row">
            <div class="col-12 vh-100 wrapper-needs-coverage-default bg-education-gap">
                ...
                <form novalidate action="{{route('validate.debt.cancellation.coverage')}}" method="POST" class="content-needs-default m-0">
                    @csrf
                    <section class="overflow-auto overflow-hidden row content-block">
                        ...
                        <div class="col-11 m-auto selection-content-coverage h-100 coverage_slick z-1">
                            <div class="slick-slide h-100 mh-100 d-flex justify-content-center align-items-center">
                                <button class="border-0 bg-transparent choice h-100 slick-padding mt-auto button-needs justify-content-center align-items-center @if($debtCancellationSelectedAvatar === 'self') default @endif" id="self" data-avatar="self" data-required="">
                            ...
                            @if ($spouseData)
                                <div class="slick-slide h-100 mh-100 d-flex justify-content-center align-items-center">
                                    <button class="border-0 bg-transparent choice h-100 slick-padding mt-auto button-needs justify-content-center align-items-center @if($debtCancellationSelectedAvatar === 'spouse') default @endif" id="spouse" data-avatar="spouse" data-required="">
                        ...
                        <div class="col-12">
                            <div class="row">
                                <div class="position-absolute bg-btn_bar bottom-0 needs-stand-bg {{ $errors->has('debtSelectedAvatarInput') ? 'error-padding' : '' }}"></div>
                            </div>
                        </div>
                    </section>
