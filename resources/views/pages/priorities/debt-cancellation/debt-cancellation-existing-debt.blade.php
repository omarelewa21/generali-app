...
<div id="debt-existing-debt"  class="vh-100 scroll-content">
        ...
        <div class="row h-100">
            <div class="col-12">
                <div class="row h-100 bg-protection bg-half wrapper-needs-supporting-default">
                    ...
                    <form novalidate action="{{route('validate.debt.existing.debt')}}" method="POST" class="m-0 content-supporting-default @if ($errors->has('existing_debt_amount')) pb-7 @endif">
                        @csrf
