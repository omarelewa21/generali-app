...
<div id="debt-critical-illness"  class="vh-100 scroll-content">
        ...
        <div class="row h-100">
            <div class="col-12">
                <div class="row h-100 bg-protection bg-half wrapper-needs-supporting-default">
                    ...
                    <form novalidate action="{{route('validate.debt.critical.illness')}}" method="POST" class="m-0 content-supporting-default @if ($errors->has('critical_coverage_amount')) pb-7 @endif">
                        @csrf
                                ...
                                <div class="row h-100" id="needs-content">
                                    <div class="col-12 col-xl-6 d-flex align-items-end justify-content-center z-1 mh-100 second-order">
                                        <div class="text-center education-support mh-100 z-1 h-100">
                                            <img src="{{ asset('images/needs/debt-cancellation/critical-illness-coverage/avatar.png') }}" class="mt-auto mh-100 h-100 mw-100 w-auto avatar-img mx-auto">
                                        </div>
