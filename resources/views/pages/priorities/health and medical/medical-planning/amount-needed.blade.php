        ...
        <div class="row vh-100 scroll-content">
            <div class="col-12">
                <div class="row h-100 bg-hnm wrapper-needs-half-master-default">
                    ...
                    <form novalidate action="{{route('validate.medical.planning.amount.needed')}}" method="POST" class="m-0 content-half-master-default @if ($errors->has('medical_amount_needed')) pb-7 @endif h-100">
                        @csrf
