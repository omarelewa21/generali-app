...
<div id="medical-summary"  class="vh-100 scrollable-content">
        ...
        <div class="row h-100">
            <div class="col-12">
                <div class="row h-100 bg-education-gap wrapper-needs-gap-default">
                    ...
                    <form novalidate action="{{route('form.submit.medical.planning.gap')}}" method="POST" class="m-0 content-gap-default">
                        @csrf
