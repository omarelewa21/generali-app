...
<div id="medical-existing-protection" class="bg-half-master">
    <div class="container-fluid">
        <div class="row mh-100">
            <form novalidate action="{{route('validate.medical.planning.existing.protection')}}" method="POST">
                @csrf
                            ...
                            <div class="row justify-content-center align-items-center">
                                ...
                                <div class="col-md-6 d-flex justify-content-md-start justify-content-sm-center">
                                    <div class="col-xxl-10 text-md-start text-sm-center text-center">
                                        <p class="f-40 f-family fw-bold lh-normal m-0 mb-md-5 mb-4">I already have Medical/ Hospitalisation coverage.</p>
                        ...
                        <div class="container">
                            <div class="row position-relative">
                                <div class="col-md-6 text-center position-absolute justify-content-center align-items-center d-flex" style="bottom: -100px">
                                    <img src="{{ asset('images/needs/health-medical/medical-planning/existing-protection/avatar.png') }}" width="auto" height="450px" alt="Increment" class="mobileImg">
                                </div>
                            </div>
                        </div>
