                    ...
                    <div class="container h-100 px-4 px-md-0">
                        <div class="row h-100">
                            <div class="col-md-6 h-100 d-flex justify-content-center align-items-end tertiary-mobile-bg">
                                ...
                                @else
                                    <img src="{{ asset('images/needs/health-medical/critical-illness/existing-protection/avatar.webp') }}" width="auto" height="100%" alt="Health Medical Critical Illness Existing Protection Avatar">
                                @endif
                            </div>
                                ...
                                <div class="row">
                                    ...
                                    <p class="d-flex pt-5 pb-3 pb-md-0">
                                        <span class="me-5 d-flex">
                                            <input type="radio" class="btn-check needs-radio @error('existing_protection_amount') checked-yes @enderror {{$existingProtection === 'yes' ? 'checked-yes' : ''}}" id="yes" name="critical_existing_protection" value="yes" autocomplete="off" onclick="jQuery('.hide-content').css('opacity','1');jQuery('#existing_protection_amount').attr('required',true);"
                                        ...
                                        <span class="d-flex me-5">
                                            <input type="radio" class="btn-check needs-radio" id="no" name="critical_existing_protection" value="no" autocomplete="off" onclick="jQuery('.hide-content').css('opacity','0');jQuery('#existing_protection_amount').removeAttr('required',false);"
