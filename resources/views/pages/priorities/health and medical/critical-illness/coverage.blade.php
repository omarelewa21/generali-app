...
<div id="critical-illness_coverage" class="secondary-default-bg coverage">
                ...
                <section class="heading">
                    <div class="container">
                        <div class="row justify-content-center ">
                            <div class="col-12">
                                <h2 class="display-5 fw-bold m-0 text-center">I'd like to provide Critical Illness Care for my:​</h2>
                            </div>
                        </div>
                    </div>
                </section>
...
<script>
    ...
    var lastPageInput = '{{json_encode($selectedCritical)}}';
