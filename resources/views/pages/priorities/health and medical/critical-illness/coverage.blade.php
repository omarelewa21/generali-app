                    ...
                    <section class="overflow-auto overflow-hidden row content-block">
                        ...
                        <div class="col-11 m-auto selection-content-coverage h-100 coverage_slick z-1">
                            <div class="slick-slide h-100 mh-100 d-flex justify-content-center align-items-center">
                                <button class="border-0 bg-transparent choice h-100 slick-padding mt-auto button-needs justify-content-center align-items-center @if($criticalIllnessSelectedAvatar === $selfData['first_name'].' '.$selfData['last_name']) default @endif" id="{{ $selfData['first_name'] }} {{ $selfData['last_name'] }}" data-avatar="{{ $selfData['first_name'] }} {{ $selfData['last_name'] }}" data-required="">
                            ...
                            @if ($spouseData)
                                <div class="slick-slide h-100 mh-100 d-flex justify-content-center align-items-center">
                                    <button class="border-0 bg-transparent choice h-100 slick-padding mt-auto button-needs justify-content-center align-items-center @if($criticalIllnessSelectedAvatar === $spouseData['first_name'] .' '. $spouseData['last_name']) default @endif" id="{{ $spouseData['first_name'] }} {{ $spouseData['last_name'] }}" data-avatar="{{ $spouseData['first_name'] }} {{ $spouseData['last_name'] }}" data-required="">
                            ...
                            @if ($childData)
                                @foreach($childData as $child)
                                    <div class="slick-slide h-100 mh-100 d-flex justify-content-center align-items-center">
                                        <button class="border-0 bg-transparent choice h-100 slick-padding mt-auto button-needs justify-content-center align-items-center @if($criticalIllnessSelectedAvatar === $child['first_name'].' '.$child['last_name']) default @endif" id="{{ $child['first_name'] }} {{ $child['last_name'] }}" data-avatar="{{ $child['first_name'] }} {{ $child['last_name'] }}" data-required="">
