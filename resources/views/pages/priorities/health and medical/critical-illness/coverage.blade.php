<?php
 /**
 * Template Name: Protection - Health Medical - Critical Illness Coverage Page
 */
?>
...
<div id="critical-illness_coverage" class="secondary-default-bg">
    <div class="container-fluid">
        <div class="row wrapper-bottom-grey">
            ...
            <form novalidate action="{{route('validate.critical.illness.coverage.selection')}}" method="POST" class="content-needs-grey">
                @csrf
                    ...
                    <div class="container">
                        <div class="row justify-content-center ">
                            <div class="col-12 pb-5">
                                <h2 class="display-5 fw-bold lh-sm text-center">I’d like to provide Critical Illness protection for my:</h2>
                            </div>
                        </div>
                    </div>
                </section>
                        ...
                        <div class="row justify-content-center h-100 coverage_slick">
                            @if ($selfData)
                                <div class="h-100 d-flex justify-content-center align-items-center col-3">
                                    <button class="border-0 bg-transparent position-relative choice d-flex justify-content-center h-100 @if($criticalIllnessSelectedAvatar === $selfData['full_name']) default @endif" id="{{ $selfData['full_name'] }}" data-avatar="{{ $selfData['full_name'] }}" data-required="">
                                        <div>
                            ...
                            @if ($spouseData)
                                <div class="h-100 d-flex justify-content-center align-items-center col-3">
                                    <button class="border-0 bg-transparent choice h-100 position-relative d-flex justify-content-center @if($criticalIllnessSelectedAvatar === $spouseData['full_name']) default @endif" id="{{ $spouseData['full_name'] }}" data-avatar="{{ $spouseData['full_name'] }}" data-required="">
                                        <div>
                            ...
                            @if ($childData)
                                @foreach($childData as $child)
                                    <div class="h-100 d-flex justify-content-center align-items-center col-3">
                                        <button class="border-0 bg-transparent choice h-100 position-relative d-flex justify-content-center @if($criticalIllnessSelectedAvatar === $child['full_name']) default @endif" id="{{ $child['full_name'] }}" data-avatar="{{ $child['full_name'] }}" data-required="">
                                            <div>
                ...
                <section class="footer fixed-bottom">
                    @if ($errors->has('criticalIllnessSelectedAvatar'))
                        <div class="container-fluid">
                            <div class="row">
                                <div class="col-12 alert alert-danger d-flex justify-content-center align-items-center py-2 m-0 rounded-0" role="alert">
                                    ...
                                    <div class="text">{{ $errors->first('criticalIllnessSelectedAvatar') }}</div>
                                </div>
                            </div>
                        </div>
                    @endif
