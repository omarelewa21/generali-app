...
<div id="education-existing-fund"  class="vh-100 scroll-content">
    <div class="container-fluid">
        <div class="row h-100">
            <div class="col-12">
                <div class="row h-100 bg-education-others wrapper-needs-half-master-default">
                            ...
                            <div class="col-sm-12 col-md-4 col-lg-6 order-sm-2 order-md-1 order-lg-1 order-2 mt-3 mt-md-0 mt-lg-0">
                                <div class="row d-flex justify-content-center align-items-center">
                                    <div class="col-lg-8 col-xl-6 bg-primary summary-progress-bar px-4 px-md-2 px-lg-2">
                                        ...
                                        <h3 id="TotalEducationFund" class="m-1 text-light text-center f-50">RM{{number_format(floatval($totalEducationNeeded)) }}</h3>
                    ...
                    <form novalidate action="{{route('validate.education.existing.fund')}}" method="POST" class="m-0 content-half-master-default @if ($errors->has('education_saving_amount')) pb-7 @endif">
                        @csrf
                                ...
                                <div class="row h-100" id="needs-monthly-content ">
                                    <div class="col-12 col-xl-6 needs-half-master-content align-items-end justify-content-center z-1 mh-100 second-order">
                                        <!-- <div class="text-center education-support mh-100 z-1 h-100"> -->
                                            <img src="{{ asset('images/needs/education/other/education-other-avatar.png') }}" class="mh-100 z-1 p-2 mw-mob h-100 m-auto">
                                        <!-- </div> -->
