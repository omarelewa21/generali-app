                    ...
                    <div class="container">
                        <div class="row justify-content-center">
                            <div class="col-md-4 bg-primary calculation-progress-bar-wrapper">
                                ...
                                <h1 id="TotalEducationFund" class="text-center display-3 text-uppercase text-white">RM{{ 
                    ...
                    <div class="container h-100">
                        <div class="row h-100">
                            ...
                            <div class="col-xl-4 col-lg-6 col-md-6 py-5 order-md-2 order-1 order-sm-1">
                                ...
                                over the next
                                    <span class="text-primary fw-bold border-bottom border-dark border-3"><input type="number" name="tertiary_education_years" class="form-control fw-bold position-relative border-0 d-inline-block w-50 text-primary @error('tertiary_education_years') is-invalid @enderror" id="tertiary_education_years" value="{{$totalEducationYear}}" required></span>
                                years.</p>
