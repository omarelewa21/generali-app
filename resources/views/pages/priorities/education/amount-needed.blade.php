...
<div id="education-amount-needed" class="bg-half-master">
    <div class="container-fluid">
        <div class="row">
            <form novalidate action="{{route('validate.education.amount.needed')}}" method="POST">
                @csrf
                                ...
                                <div class="col-12 col-md-4 col-lg-6 order-sm-2 order-md-1 order-lg-1 order-2 mt-3 mt-md-0">
                                    <div class="row justify-content-center">
                                        <div class="col-lg-8 col-xl-6 bg-primary calculation-progress-bar-wrapper px-4 px-md-2">
                                            ...
                                            <h3 id="TotalEducationFund" class="text-light text-center m-1 f-family">RM{{ 
                            ...
                            <div class="row justify-content-center align-items-center">
                                ...
                                <div class="col-md-6 d-flex justify-content-md-start justify-content-sm-center">
                                    <div class="col-xxl-9 text-md-start text-sm-center text-center">
                                        <p class="f-40 f-family fw-bold lh-normal m-0">I plan to fund my child's education with a total of<br>
                                            <span class="text-primary fw-bold border-bottom border-dark border-3">RM<input type="text" name="tertiary_education_amount" class="form-control f-40 f-family fw-bold position-relative border-0 d-inline-block w-50 text-primary @error('tertiary_education_amount') is-invalid @enderror" id="tertiary_education_amount" value="{{ $tertiaryEducationAmount !== null ? number_format(floatval($tertiaryEducationAmount)) : $tertiaryEducationAmount }}" required></span>
                                            . I plan to take 
                                            <span class="text-primary fw-bold border-bottom border-dark border-3"><input type="text" name="tertiary_education_years" class="form-control f-40 f-family fw-bold position-relative border-0 d-inline-block w-50 text-primary @error('tertiary_education_years') is-invalid @enderror" id="tertiary_education_years" value="{{$totalEducationYear}}" required></span>
                        ...
                        <div class="container">
                            <div class="row position-relative">
                                <div class="col-md-6 text-center position-absolute justify-content-center align-items-center d-flex" style="bottom: -150px">
                                    <img src="{{ asset('images/needs/education/amount-needed/avatar.png') }}" width="auto" height="450px" alt="Education Amount Needed Avatar" class="mobileImg">
                                </div>
                            </div>
                        </div>
