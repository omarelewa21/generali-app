            ...
            <!-- <form novalidate action="{{route('validate.education.coverage.selection')}}" method="POST" class="p-mb-0 m-0">
                ...
                <div class="col-12 vh-100 wrapper-needs-coverage-default bg-education-home">
                    ...
                    <form novalidate action="{{route('validate.education.coverage.selection')}}" method="POST" class="content-needs-default m-0">
                        @csrf
                        <section class="overflow-auto overflow-hidden bg-education-coverage row content-block">
                        ...
                        @if ($errors->has('educationSelectedAvatarInput'))
                            <section class="row warning">
                                <div class="col-12 alert alert-danger d-flex justify-content-center align-items-center m-0 rounded-0" role="alert">
