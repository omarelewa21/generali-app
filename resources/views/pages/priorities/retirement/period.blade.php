                            ...
                            <div class="row justify-content-center align-items-center">
                                ...
                                <div class="col-md-6 d-flex justify-content-md-start justify-content-sm-center">
                                    <div class="col-xxl-9 text-md-start text-sm-center text-center">
                                        <p class="f-40 f-family fw-bold lh-normal m-0">I plan to retire at the age of<br>
                                            <span class="text-primary fw-bold border-bottom border-dark border-3"><input type="text" name="retirement_age" class="form-control f-40 f-family fw-bold position-relative border-0 d-inline-block w-50 text-primary @error('retirement_age') is-invalid @enderror" id="retirement_age" value="{{$retirementAge}}" required></span>
                                            , so that I can enjoy my golden retirement life for the next
                                            <span class="text-primary fw-bold border-bottom border-dark border-3"><input type="text" name="supporting_years" class="form-control f-40 f-family fw-bold position-relative border-0 d-inline-block w-50 text-primary @error('supporting_years') is-invalid @enderror" id="supporting_years" value="{{$supportingYears}}" required></span>
                                            years.
                                        </p>
                        ...
                        <div class="container">
                            <div class="row position-relative">
                                <div class="col-md-6 text-center position-absolute justify-content-center align-items-center d-flex" style="bottom: -150px">
                                    <img src="{{ asset('images/needs/retirement/retire-age/retire-age-avatar.png') }}" width="auto" height="500px" alt="Retirement Year" class="mobileImg">
                                </div>
                            </div>
                        </div>
