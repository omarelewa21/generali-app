...
@php
    ...
    $retirementMonthlySupport = isset($arrayData['retirement']['retirementMonthlySupport']) ? $arrayData['retirement']['retirementMonthlySupport'] : '';
...
<div id="retirement-monthly" class="vh-100 scroll-content">
        ...
        <div class="row h-100">
            <div class="col-12">
                <div class="row h-100 bg-protection bg-half wrapper-needs-supporting-default">
                    ...
                    <form novalidate action="{{route('validate.retirement.monthly.support')}}" method="POST" class="m-0 content-supporting-default @if ($errors->has('retirement_monthly_support')) pb-7 @endif h-100">
                        @csrf
