        ...
        <div class="row vh-100 scroll-content">
            <div class="col-12">
                <div class="row h-100 bg-retire-age wrapper-needs-half-master-default">
                    ...
                    <form novalidate action="{{route('validate.others')}}" method="POST" class="m-0 content-half-master-default @if ($errors->has('retirement_savings') || $errors->has('other_income_sources')) pb-7 @endif h-100">
                        @csrf
                            ...
                            <div class="col-12 position-relative mh-100">
                                <div class="row h-100" id="needs-content">
                                    <div class="col-12 col-xl-6 align-items-end justify-content-center z-1 mh-100 second-order needs-half-master-content mt-auto">
                                        <img src="{{ asset('images/needs/retirement/other/avatar.png') }}" class="mh-100 z-1 p-2 mw-mob h-100 m-auto">
