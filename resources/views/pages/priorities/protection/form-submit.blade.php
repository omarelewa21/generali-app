                                    ...
                                    <div class="col-12">
                                        <div class="row">
                                            <div class="col-md-3">
                                                ...
                                                <select class="form-select is-valid" aria-label="Title" required>
                                        ...
                                        <div class="row">
                                            <div class="col-md-6 mt-5">
                                                ...
                                                <input type="text" class="form-control is-invalid" id="firstNameInput" placeholder="First Name" aria-describedby="validationServer03Feedback" required>
                            ...
                            <div class="container-fluid">
                                <div class="row">
                                    <div class="col-12 d-grid gap-2 d-md-block text-end px-5">
                                        ...
                                        <a href="{{route('avatar.welcome') }}" class="btn btn-primary text-uppercase" type="submit">Next</a>
                                    </div>
                                </div>
                            </div>
                        </section>
