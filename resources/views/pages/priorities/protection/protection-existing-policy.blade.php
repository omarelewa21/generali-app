        ...
        <div class="row vh-100 scroll-content">
            <div class="col-12">
                <div class="row h-100 bg-half-content wrapper-needs-half-master-default">
                            ...
                            <div class="col-sm-12 col-md-4 col-lg-6 order-sm-2 order-md-1 order-lg-1 order-2 mt-3 mt-md-0 mt-lg-0">
                                <div class="row d-flex justify-content-center align-items-center">
                                    <div class="col-lg-8 col-xl-6 bg-primary summary-progress-bar px-4 px-md-2 px-lg-2">
                                        ...
                                        <h3 id="TotalProtectionFund" class="m-1 text-light text-center f-50">RM{{ $existingPolicyAmount === null || $existingPolicyAmount === '' ? number_format(floatval($newTotalProtectionNeeded)) : ($newTotalProtectionNeeded > $existingPolicyAmount ? number_format(floatval($newTotalProtectionNeeded - $existingPolicyAmount)) : '0') }}</h3>
                    ...
                    <form novalidate action="{{route('validate.protection.existing.policy')}}" method="POST" class="m-0 content-half-master-default @if ($errors->has('existing_policy_amount')) pb-7 @endif">
                        @csrf
                            ...
                            <div class="col-12 position-relative mh-100">
                                <div class="row h-100" id="needs-content">
                                    <div class="col-12 col-xl-6 align-items-end justify-content-center z-1 mh-100 second-order needs-half-master-content mt-auto">
                                        <div class="text-center image-content-spacing mh-100 z-1 h-100">
