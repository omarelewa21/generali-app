                    ...
                    <section class="main-content scrollable-padding">
                        <div class="container">
                            <div class="row d-flex justify-content-center">
                                <img src="{{ asset('images/needs/protection/protection-home-avatar.png') }}" style="width:350px" alt="Protection">
                            </div>
                            <div class="row pt-4 px-5 pb-3 pt-xxl-5 pt-xl-5 pt-lg-5 pt-md-5 pt-sm-4 bg-accent-bg-grey text-center">
                                <div class="col-12">
