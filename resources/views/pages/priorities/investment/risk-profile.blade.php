...
@php
    ...
    $investmentRiskProfile = session('customer_details.selected_needs.need_5.advance_details.risk_profile','High Risk');
    $investmentPotentialReturn = session('customer_details.selected_needs.need_5.advance_details.potential_return','High');
                        ...
                        <div class="row h-100">
                            ...
                            <div class="col-xl-4 col-lg-6 col-md-6 py-lg-0 pt-4 calculatorContent">
                                ...
                                <div class="col-12 mb-3 z-1" id="high-risk-potential-content" style="display:none;">
                                    ...
                                    <div class="row mb-3">
                                        <div class="col-12 d-flex">
                                            <button class="potential-btn risk-potential-content f-family @if($investmentRiskProfile === 'High Risk' && $investmentPotentialReturn === 'High') default @endif" id="high-potential-return" data-risk="High" data-required="">High</button>
                                            <button class="potential-btn risk-potential-content border-start-0 border-end-0 f-family @if($investmentRiskProfile === 'High Risk' && $investmentPotentialReturn === 'Medium') default @endif" id="medium-potential-return" data-risk="Medium" data-required="">Medium</button>
                                            <button class="potential-btn risk-potential-content f-family @if($investmentRiskProfile === 'High Risk' && $investmentPotentialReturn === 'Low') default @endif" id="low-potential-return" data-risk="Low" data-required="">Low</button>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-12 mb-3 z-1">
                                ...
                                <div class="col-12 mb-3 z-1" id="medium-risk-potential-content" style="display:none;">
                                    ...
                                    <div class="row mb-3">
                                        <div class="col-12 d-flex">
                                            <button class="potential-btn risk-potential-content f-family @if($investmentRiskProfile === 'Medium Risk' && $investmentPotentialReturn === 'High') default @endif" id="high-potential-return" data-risk="High" data-required="">High</button>
                                            <button class="potential-btn risk-potential-content border-start-0 border-end-0 f-family @if($investmentRiskProfile === 'Medium Risk' && $investmentPotentialReturn === 'Medium') default @endif" id="medium-potential-return" data-risk="Medium" data-required="">Medium</button>
                                            <button class="potential-btn risk-potential-content f-family @if($investmentRiskProfile === 'Medium Risk' && $investmentPotentialReturn === 'Low') default @endif" id="low-potential-return" data-risk="Low" data-required="">Low</button>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-12 mb-3 z-1">
                                ...
                                <div class="col-12 mb-3 risk-potential-content" id="low-risk-potential-content" style="display:none;">
                                    ...
                                    <div class="row mb-3">
                                        <div class="col-12 d-flex">
                                            <button class="potential-btn risk-potential-content f-family @if($investmentRiskProfile === 'Low Risk' && $investmentPotentialReturn === 'High') default @endif" id="high-potential-return" data-risk="High" data-required="">High</button>
                                            <button class="potential-btn risk-potential-content border-start-0 border-end-0 f-family @if($investmentRiskProfile === 'Low Risk' && $investmentPotentialReturn === 'Medium') default @endif" id="medium-potential-return" data-risk="Medium" data-required="">Medium</button>
                                            <button class="potential-btn risk-potential-content f-family @if($investmentRiskProfile === 'Low Risk' && $investmentPotentialReturn === 'Low') default @endif" id="low-potential-return" data-risk="Low" data-required="">Low</button>
                                        </div>
                                    </div>
                                </div>
