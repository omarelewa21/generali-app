            ...
            <div class="col-12 vh-100 wrapper-needs-coverage-default bg-education-gap">
                ...
                <form novalidate action="{{route('validate.investment.coverage.selection')}}" method="POST" class="content-needs-default m-0">
                    ...
                    <section class="overflow-auto overflow-hidden row content-block">
                        ...
                        <div class="col-11 m-auto selection-content-coverage h-100 investment_coverage z-1">
                        ...
                        <div class="container-fluid">
                            <div class="row">
                                <div class="col-12 d-flex gap-2 d-md-block text-end px-4">
                                    ...
                                    <a href="{{route('investment.home')}}" class="btn btn-primary flex-fill me-md-2 text-uppercase">Back</a>
