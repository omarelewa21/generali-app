                    ...
                    <div class="container">
                        <div class="row justify-content-center ">
                            <div class="col-xxl-6 col-xl-6 pb-5">
                                <h2 class="display-4 text-center">Total Investment Fund</h2>
                            </div>
                        </div>
                    </div>
                </section>
                                ...
                                <div class="row justify-content-center py-2">
                                    <div class="col-10 d-flex align-items-center">
                                        <div class="d-flex bg-white rounded p-3 align-items-center border w-100 justify-content-between">
                                            ...
                                            <h4 class="display-5 fw-bold lh-sm m-0 text-primary text-end">{{$investmentSupportingYears}} years</h4>
                                        </div>
                                    </div>
                                ...
                                <div class="row justify-content-center py-2">
                                    <div class="col-10 d-flex align-items-center">
                                        <div class="d-flex bg-white rounded p-3 align-items-center border w-100 justify-content-between">
                                            ...
                                            <h4 class="display-5 fw-bold lh-sm m-0 text-primary text-end">RM {{number_format(floatval($totalInvestmentNeeded))}}</h4>
                                        </div>
                                    </div>
                                    <span class="align-self-center green-tick"></span>
                                </div>
                                <div class="row justify-content-center py-2">
                                    <div class="col-10 d-flex align-items-center">
                                        <div class="d-flex bg-white rounded p-3 align-items-center border w-100 justify-content-between">
                                            ...
                                            <h4 class="display-5 fw-bold lh-sm m-0 text-primary text-end">{{$investmentPA}}% p.a.</h4>
                                        </div>
                                    </div>
                                    <span class="align-self-center green-tick"></span>
                                </div>
...
<script>
    ...
    var newTotalInvestmentNeeded = {{$totalInvestmentNeeded}};
