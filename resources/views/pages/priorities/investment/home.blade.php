                ...
                <div class="wrapper-needs-grey main-default-bg">
                    ...
                    <section class="content-needs">
                        <div class="col-12 d-flex justify-content-center align-items-center position-relative">
                            <img src="{{ asset('images/needs/investment/home/avatar.png') }}" height="100%" width="auto" class="position-absolute" style="bottom:-70px" alt="Investment Home">
                        </div>
                    </section>
                            ...
                            <div class="container-fluid">
                                <div class="row">
                                    <div class="col-12 d-flex gap-2 d-md-block text-end px-4">
                                        <a href="{{route('savings.gap')}}" class="btn btn-secondary text-uppercase flex-fill me-md-2">Back</a>
