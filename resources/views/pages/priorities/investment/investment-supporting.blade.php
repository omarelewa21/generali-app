...
<div id="investment-supporting">
    <div class="container-fluid overflow-hidden font-color-default">
        <div class="row bg-investment-supporting text-center" style="max-height:100vh;height:100vh;">
                    ...
                    <div class="row h-100 overflow-y-auto overflow-x-hidden">
                        <div class="col-12 hide">
                           <div class="row d-flex justify-content-center h-100">
                                ...
                                <div class="col-xl-6 col-12 position-relative mt-4 h-100">
                                    <img src="{{ asset('images/needs/investment/Calendar.png') }}" class="m-auto h-75">
                                    <div class="position-absolute center w-100">
                                        ...
                                        <p style="font-size:34px;" class="mt-4"><strong>years</strong></p>
                                    </div>
                                </div>
                            </div>
                        </div>
