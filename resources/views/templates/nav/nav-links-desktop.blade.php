...
<div class="offcanvas offcanvas-start" tabindex="-1" id="offcanvasMenu">
    ...
    <div class="footer-navigation col-12">
        <div class="col-12 px-5 py-4 inline-block">
            ...
            <a href="{{route('clear_session_storage')}}" class="btn btn-outline-secondary btn-exit text-uppercase" type="button" data-bs-toggle="modal" data-bs-target="#staticBackdrop">
            Save & Logout</a>
