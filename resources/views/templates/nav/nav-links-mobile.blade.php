...
<div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasMenuMobile">
    ...
    <div class="footer-navigation col-12">
        <div class="col-12 px-5 py-4 inline-block">
            ...
            <a href="{{route('welcome')}}" class="btn btn-outline-secondary btn-exit text-uppercase p-3" type="button" data-bs-toggle="modal" data-bs-target="#staticBackdrop">
            Save & Logout</a>
        </div>
    </div>
</div>
