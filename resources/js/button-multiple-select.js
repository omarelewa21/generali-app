    ...
    childrenConfirmButton.addEventListener('click', function() {
        ...
        if (selectedChildButton) {
            if (selectedChildren > 0) {
                ...
                selectedChildButton.removeAttribute('data-required', 'selected');
            }
        }
    });
