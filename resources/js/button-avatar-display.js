...
if (specificPageURLs.some((url) => currentURL.endsWith(url))) {
    ...
    document.addEventListener("DOMContentLoaded", function () {
        ...
        if (path == "/marital-status") {
            ...
            if (preselect.value == "Married") {
                ...
                if (gender_session) {
                    if (gender_session == "Male") {
                        ...
                        var newDiv =
                            '<div id="lottie-male-animation" class="appended-image"></div>';
                        $(".imageContainerMarried").append(newDiv);

                        const animationMale = lottie.loadAnimation({
                            container: document.getElementById(
                                "lottie-male-animation"
                            ),
                            renderer: "svg",
                            loop: true,
                            autoplay: true,
            ...
            var familyDependentInputValue = document.getElementById(
            ...
            if (familyDependentInputValue.trim() !== "null") {
                ...
                if (familyDependent.children_data) {
                    ...
                    var numberOfChildren = Object.keys(
                        familyDependent.children_data
                    ).length;
                    ...
                    if (numberOfChildren >= 2) {
                        ...
                        var newDiv =
                            '<div id="lottie-daughter-animation"></div>';
                        $(".imageContainerChildren").append(newDiv);

                        const animationSon = lottie.loadAnimation({
                            container: document.getElementById(
                                "lottie-daughter-animation"
                            ),
                            renderer: "svg",
                            loop: true,
                            autoplay: true,
                    ...
                    var newButton =
                        '<div class="popover position-absolute py-1" style="top:10%;right:inherit"> x' +
                        numberOfChildren +
                        "</div>";
                    ...
                    var $appended =
                        $imageContainerSpouseDom.find(".appended-image");

                    if ($appended.length == "0") {
                        var $sonContainer = document.querySelector(
                            "#lottie-son-animation"
                        );
                        var $daughterContainer = document.querySelector(
                            "#lottie-daughter-animation"
                        );
                ...
                if (familyDependent.parents_data) {
                    if (
                        familyDependent.parents_data.hasOwnProperty("father") &&
                        familyDependent.parents_data.hasOwnProperty("mother")
                    ) {
                        ...
                        var newDivFather =
                            '<div id="lottie-father-animation"></div>';
                        var newDivMother =
                            '<div id="lottie-mother-animation"></div>';
                        ...
                        var $fatherContainer = document.querySelector(
                            "#lottie-father-animation"
                        );
            ...
            if (preselect.trim() !== "") {
                ...
                if (assets && assets.car === true) {
                    var newImage =
                        '<img src="' +
                        carImages[carImageIndex].src +
                        '" width="' +
                        carImages[carImageIndex].width +
                        '" height="' +
                        carImages[carImageIndex].height +
                        '" alt="' +
                        carImages[carImageIndex].alt +
                        '" class="' +
                        carImages[carImageIndex].class +
                        '" style="' +
                        carImages[carImageIndex].style +
                        '">';
                ...
                if (assets && assets.scooter === true) {
                    var newImage =
                        '<img src="' +
                        scooterImages[scooterImageIndex].src +
                        '" width="' +
                        scooterImages[scooterImageIndex].width +
                        '" height="' +
                        scooterImages[scooterImageIndex].height +
                        '" alt="' +
                        scooterImages[scooterImageIndex].alt +
                        '" class="' +
                        scooterImages[scooterImageIndex].class +
                        '" style="' +
                        scooterImages[scooterImageIndex].style +
                        '">';
                    $(".imageContainerCar").append(newImage);
                }
                ...
                if (assets && assets.house === true) {
                    var newImage =
                        '<img src="' +
                        houseImages[houseImageIndex].src +
                        '" width="' +
                        houseImages[houseImageIndex].width +
                        '" height="' +
                        houseImages[houseImageIndex].height +
                        '" alt="' +
                        houseImages[houseImageIndex].alt +
                        '" class="' +
                        houseImages[houseImageIndex].class +
                        '" style="' +
                        houseImages[houseImageIndex].style +
                        '">';
                ...
                if (assets && assets.bungalow === true) {
                    var newImage =
                        '<img src="' +
                        bungalowImages[bungalowImageIndex].src +
                        '" width="' +
                        bungalowImages[bungalowImageIndex].width +
                        '" height="' +
                        bungalowImages[bungalowImageIndex].height +
                        '" alt="' +
                        bungalowImages[bungalowImageIndex].alt +
                        '" class="' +
                        bungalowImages[bungalowImageIndex].class +
                        '" style="' +
                        bungalowImages[bungalowImageIndex].style +
                        '">';
                    $(".imageContainerHouse").append(newImage);
                }
                ...
                if (assets && assets.condo === true) {
                    var newImage =
                        '<img src="' +
                        condoImages[condoImageIndex].src +
                        '" width="' +
                        condoImages[condoImageIndex].width +
                        '" height="' +
                        condoImages[condoImageIndex].height +
                        '" alt="' +
                        condoImages[condoImageIndex].alt +
                        '" class="' +
                        condoImages[condoImageIndex].class +
                        '" style="' +
                        condoImages[condoImageIndex].style +
                        '">';
                    $(".imageContainerHouse").append(newImage);
                }
            ...
            for (const key in selectedAssets) {
                if (
                    selectedAssets.hasOwnProperty(key) &&
                    selectedAssets[key] !== true
                ) {
        ...
        var familyDependentButtonInput = document.getElementById(
            "familyDependentButtonInput"
        );
        ...
        $(".btn-exit-children").on("click", function () {
            ...
            if (familyDependentButtonInput.value == "") {
                familyDependentButtonInput.value =
                    JSON.stringify(clickedAvatars);
            } else {
            ...
            if (familyDependent.spouse === true) {
                ...
                if (
                    (familyDependent.children === undefined ||
                        familyDependent.children === false) &&
                    (familyDependent.parents === undefined ||
                        familyDependent.parents === false) &&
                    (familyDependent.siblings === undefined ||
                        familyDependent.siblings === false)
                ) {
        ...
        $(".btn-exit-parent").on("click", function () {
            ...
            if (
                ...
                if (
                    ...
                    selectedImages[0].alt === "Grandfather"
                ) {
                    console.log(selectedImages);
                    if (
                        !selectedImages[0].class.includes("position-absolute")
                    ) {
        ...
        $("#siblingButton").on("click", function () {
            var isSelected =
                this.closest(".button-bg").classList.contains("selected");
        ...
        // Others Selection
        $(document).on("click", ".btn-exit-assetsOthers", function () {
