...
class AvatarController extends Controller
{
    public function changeImage(Request $request)
    {
        ...
        // $selectedGender = $request->input('genderSelection');
        ...
        //     $storedSelectedGender = $selectedGender;
        // }
        ...
        //     $modifiedSvgPath = public_path('images/avatar-general/' . $storedImage . '-1.svg');
        ...
        //     'image' => asset('images/avatar-general/' . $storedImage . '-1.svg'),
        //     'image_new' => $storedGenderImage,
        //     'gender' => $storedGender,
        //     'gender_new' => $storedSelectedGender,
